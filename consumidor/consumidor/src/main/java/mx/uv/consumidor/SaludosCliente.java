...
public class SaludosCliente extends WebServiceGatewaySupport {
    ...
    public SaludarResponse saludar(String nombre) {
        ...
        SaludarResponse saludarResponse = (SaludarResponse) getWebServiceTemplate().marshalSendAndReceive("http://ip172-18-0-68-ch06818sf2q000dg1240-8081.direct.labs.play-with-docker.com/ws/", sr);
